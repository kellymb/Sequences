...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 0
    actual = sum_first_n([10000000, -10000000, 50, 5], 2)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 100
    actual = sum_first_n([10, 20, 30, 40, 50, 60, 70], 4)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', actual)

...
def run_test_count_negatives():
    ...
    expected = 5
    actual = count_negatives([-3, 0, -7, 5, 7, -9, -8, -6000])
    print()
    print('Test 6 expected:', expected)
    print('       actual:  ', actual)

    expected = 2
    actual = count_negatives([0, 0, 7, 5, 7, -9, -8, 6000])
    print()
...
def run_test_count_short_ones():
    ...
    expected = 3
    seq = [[5, 5, 5], ['gggg'], ['jjj', 'adhcgacejgh'], []]
    actual = count_short_ones(seq)
    print()
    ...
    expected = 6
    seq = [[5, 5], ['gggg'], ['jjj', 'adhcgacejgh'], [], ['g', 'g'], []]
    actual = count_short_ones(seq)
    print()
...
def draw_circles(window, points, radius, color):
    ...
    for h in range(len(points)):
        circle = rg.Circle(points[h], radius)

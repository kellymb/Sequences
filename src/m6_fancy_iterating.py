...
def print_items_at_odd_indices(sequence):
    ...
    for J in range(len(sequence)):
        if J % 2 == 1:
            print(sequence[J], 'is at index', J)
...
def print_items_that_are_bigger_than_5(sequence):
    ...
    for p in range(len(sequence)):
        if sequence[p] > 5:
            print(sequence[p], "is at index", p)
...
def print_items_that_are_strings(sequence):
    ...
    # ------------------------------------------------------------------
    for h in range(len(sequence)):
        if type(sequence[h]) is str:
            print(sequence[h], 'is at index', h)
...
def print_items_that_are_odd_integers(sequence):
    ...
    for g in range(len(sequence)):
        if type(sequence[g])is int:
            if sequence[g]%2 == 1:
                print(sequence[g], 'is at index', g)
